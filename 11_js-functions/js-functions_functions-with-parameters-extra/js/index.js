...
// function mit variable area = parameter/arguement 1 + 2 als interne variable, dann console log

function printRectangleArea(width, length) {
  const rectangArea = width * length;
  console.log("THe area of the rectangle is " + rectangArea);
}

printRectangleArea(5, 7);
printRectangleArea(3, 4);
printRectangleArea(100, 8);
